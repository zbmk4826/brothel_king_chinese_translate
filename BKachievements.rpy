...
init python:
    achievement_list = [
                        ...
                        Achievement("新的商户：莉琪", "莉琪出售她在植物园里采摘的鲜花。", pic="portrait.webp", pic_path="NPC/Riche/", target="merchant riche"),
                        Achievement("新的商户：凯特琳", "凯特琳卖小饰品，脾气很暴躁。", pic="portrait.webp", pic_path="NPC/Katryn/", target="merchant katryn"),
...
#                         Achievement("Bedded: The Adventurer", "You had sex with Scarlet.", pic="portrait.webp", pic_path="NPC/Jobgirl/", target="h jobgirl"), # Event not ready yet?
                        ...
                        Achievement("健步如飞", "有 %s 个女孩的体质超过 %s 。", pic="portrait.webp", pic_path="NPC/Jobgirl/", target="Constitution", level_nb=5, requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 50, 2 : 100, 3 : 150, 4 : 200, 5 : 250}),
                        ...
                        Achievement("性虐精通", "有 %s 个女孩的性虐技能超过 %s 。", pic="portrait.webp", pic_path="NPC/Stella/", target="Fetish", level_nb=5, requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 50, 2 : 100, 3 : 150, 4 : 200, 5 : 250}),
                        ...
                        Achievement("Knock On Wood", "你解锁了木匠的货车。", pic="portrait.webp", pic_path="NPC/Carpenter/", target="wagon"),
                        Achievement("Sewer Knight", "你在下水道里解救了囚犯。", pic="portrait naked.webp", pic_path="NPC/Sewer girl/", target="sewer defender"),
                        Achievement("Enduring", "科斯莫骚扰了你 %s 次。", pic="portrait.webp", pic_path="NPC/Kosmo/", target="kosmo", level_nb=4, requirements={1 : 1, 2 : 5, 3 : 10, 4 : 20}),
                        ...
                        Achievement("性虐狂热", "让女孩进行性虐 %s 次。", pic="ropes.webp", pic_path="items/toy/", target="perform fetish", level_nb=5, requirements={1 : 1, 2 : 10, 3 : 100, 4 : 1000, 5 : 10000}),
