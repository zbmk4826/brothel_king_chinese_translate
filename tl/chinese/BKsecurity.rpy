...
translate chinese security_56178303:
    ...
    security "你的第一次进攻就冲破了他们的阵型，他们很快就被驱散了。这时你听到了一声尖叫。"
...
translate chinese security_67702c78:
    ...
    "[girl.fullname]被独自留了下来，但她并没有坐以待毙。当你的对手忙着攻击你的时候，她绕到了敌人的背后朝他刺去！敌人因为疼痛尖叫了起来，扭头逃跑。"
...
translate chinese security_3f8d1a4f:
    ...
    "在[enemy_general.name]反应之前，你就击落了她手中的武器，然后用剑抵住着她的喉咙。"
...
translate chinese security_f65ca89d:
    ...
    "看到他们的首领被打败，其余的雇佣兵停止了攻击，四散逃跑。你{b}赢{/b}下了这场战斗。"
...
translate chinese security_d068958f:
    ...
    "她扑通一声倒在地上，一动不动，陷入昏迷。看到他们的首领被打败，其余的雇佣兵停止了攻击，四散逃跑。你{b}赢{/b}下了这场战斗。"
...
translate chinese security_eaac5125:
    ...
    "她抓住了她脖子上的护身符，喃喃念着咒语。当你的第二道闪电击中她原本站立的地方时，她瞬间变得透明，消失在空气中。原来是瞬移魔法！"
...
translate chinese security_afc1f367:
    ...
    "你的姑娘们找到了敌方将军[enemy_general.fullname]留下的东西。"
...
translate chinese security_17421a6e:
    ...
    you "好啊...一个有如此精神的女人将成为血岛恶魔领主的完美祭品..."
...
translate chinese security_16619f94:
    ...
    you "哦，但我是。希露，带她去血奴贩子的厨房。我再也不想听到那个婊子的消息了。"
...
translate chinese security_64d9bf4f:
    ...
    enemy_general.char "好吧，我向你保证。我会离开瓒城。"
...
translate chinese kidnap_tip_4db04105:
    ...
    man "但是如果你不听的话，你会后悔的。还记得可爱的小[girl.fullname]吗？"
...
translate chinese kidnap_tip_89c009f7:
    ...
    man "嘿，没必要给我{i}那样{/i}的表情。我和那些带走她的家伙不是一伙的。"
...
translate chinese kidnap_tip_b311a25b:
    ...
    man "我会的，我会的，但是我的喉咙非常渴...再加上我欠红海海盗几枚小小的硬币，其实只是一点点，但他们很生气..."
...
translate chinese kidnap_tip_24238d43:
    ...
    man "好吧，我们说的是个阶级为[rk]的贱女人……那就[price]枚金币。这样的信息已经算是很便宜了。"
...
translate chinese kidnap_rescue_62968ca6:
    ...
    "你到达了[loc]，这就是[girl.fullname]被囚禁的地方。"
...
translate chinese kidnap_rescue_5c5d18ea:
    ...
    "按照线人的指示，你开始寻找[girl.fullname]被囚禁的洞穴入口。"
...
translate chinese kidnap_rescue_021d2cee:
    ...
    "在阴影中潜行，你来到一扇锁着的门前。闷闷的哭声从门的另一边传来。"
...
translate chinese kidnap_rescue_1ce9ffeb:
    ...
    "一个食人魔正在无情地干着[girl.fullname]，他巨大的阴茎弄得她的内脏翻江倒海。"
...
translate chinese kidnap_rescue_922e8855:
    ...
    "一个令人作呕的恶魔正在后面干着[girl.fullname]的屁股，往她的后面肉穴里喷出粘稠的怪物精液。"
...
translate chinese kidnap_rescue_807b0341:
    ...
    "一个守卫正在嘲笑和嘲弄[girl.fullname]，当她被一个奇怪的装置逗弄和干着时。"
...
translate chinese kidnap_rescue_2e9ba7a2:
    ...
    "敌人被分散了注意力。如果你能通过那扇门，你就有机会快速结束这一切。"
...
translate chinese kidnap_rescue_3057cbf5:
    ...
    "你破门而入，用剑将食人魔刺穿，切开了他的内脏。他的眼睛露出了惊愕的表情，他扑通一声倒在尘土中，死了。"
...
translate chinese kidnap_rescue_3b0d7b3a:
    ...
    "你从后面袭击，刺向那个暴徒的脖子，然后将她毫无生气的尸体扔到一边，然后冲过去解救[girl.name]。"
...
translate chinese kidnap_rescue_56eb5a18:
    ...
    "你猛地撞击牢门，只是伤到了自己的肩膀。噪音惊动了你的敌人，你可以听到闷闷的尖叫声，[girl.fullname]被拖走了。"
...
translate chinese kidnap_rescue_13a83ec7:
    ...
    "你用一道闪电击中了食人魔，在他被炸死的过程中你短暂地看到他骨架的轮廓，你的女孩及时逃脱，她的头发因静电而竖立起来。"
...
translate chinese kidnap_rescue_c43cbf0e:
    ...
    "你向那个怪物你认为是头的地方扔了一个火球，将它烤熟了。怪物毫无生气地倒在了泥土里。"
...
translate chinese kidnap_rescue_ee6958e7:
    ...
    "你轻松地用闪电法术击倒了守卫，让他在几秒钟内成为艺术灯柱。当你解救[girl.name]时，他化为了灰烬。"
...
translate chinese kidnap_rescue_0d84744f:
    ...
    "你的法术失败了，你拼命地摆弄着锁，试图找到另一种打开门的方法。"
...
translate chinese kidnap_rescue_3a714312:
    ...
    "你被发现了！一个巨大的食人魔咆哮着发现了你。当[girl.fullname]被拖走时，你拼命逃跑。"
...
translate chinese kidnap_rescue_67179ae3:
    ...
    "怪物已经察觉到你的存在！你听到[girl.fullname]的尖叫声，她正在被带走。"
