...
label init_game(quick=False):
    ...
    #### NPCs #### Declare unique NPCs
        ...
        NPC_twins = NPC(name = "Today",cnname = "今日子", char=today, trainer_portrait = "side today", item_types=["Dress", "Accessory"])
        ...
        NPC_willow = NPC(name="Willow",cnname = "薇洛", char=willow, minion_type="monster")
        NPC_gina = NPC(name="Gina",cnname = "吉娜", char=gina, minion_type="machine")
        ...
        NPC_jobgirl = NPC(name="Scarlet",cnname = "斯卡雷特", char=jobgirl)
...
#            MC.trainers.append(NPC_sad_sill)
    ...
    python:
        ...
        sewers = Location("Sewers", pic = "Sewers.webp", menu = ("拜访怪物捕手", "visit_willow"), menu_costs_AP=False) # Monster merchant
        farmland = Location("Farm", pic = "farmland.jpg", menu = ("拜访牧场主人", "visit_goldie"), menu_costs_AP=False) # Beast merchant
        watchtower = Location("Watchtower", pic = "Watchtower.jpg", menu = ("去队长的地下室", "visit_watchtower"))
        junkyard = Location("Junkyard", pic = "Junkyard.webp", menu = ("拜访科学家", "visit_gina"), menu_costs_AP=False) # Machine merchant
        thieves_guild = Location("Thieves guild", pic = "Thieves guild.jpg", secret = True, menu = ("去公会仓库", "visit_thieves_guild"))

        harbor = Location("Harbor", pic = "Harbor.jpg", menu = ("拜访种马贩子", "visit_stella"), menu_costs_AP=False) # Stallion merchant
        ...
        seafront = Location("Seafront", pic = "Seafront.jpg", menu = ("拜访怪胎爸爸", "visit_papa"), menu_costs_AP=False)
        beach = Location("Beach", pic = "Beach.jpg", menu = ("酿造染料", "collect_dye")) # Dye
        exotic_emporium = Location("Exotic emporium", pic = "Exotic emporium.jpg", menu = ("去礼品店", "visit_giftgirl"), menu_costs_AP=False) # Gift girl, gifts

        stables = Location("Stables", pic = "Stables.jpg", menu = ("获取皮革", "collect_leather")) # Leather
        plaza = Location("Plaza", pic = "Plaza.jpg", menu = ("联系焰", "c3_contact_homura"), menu_costs_AP=False) # Homura, story
        market = Location("Market", pic = "Market.jpg", menu = ("去交换所", "visit_exchange"), action=True, menu_costs_AP=False) # Resource market
        gallows = Location("Gallows", pic = "Gallows.jpg", menu = ("拜访怪胎老爹", "visit_papa"), menu_costs_AP=False)
        prison = Location("Prison", pic = "Prison.jpg", menu = ("去古利古拉的小摊", "visit_gurigura"), menu_costs_AP=False) # Gurigura, toys
        arena = Location("Arena", pic = "Arena.jpg", menu = ("去武器店", "visit_ramias"), menu_costs_AP=False) # Ramias, weapons

        botanical_garden = Location("Botanical garden", pic = "Botanical garden.jpg", menu = ("去花摊", "visit_riche"), menu_costs_AP=False) # Riche, flowers
        hanging_gardens = Location("Hanging gardens", pic = "Hanging gardens.jpg", menu = ("织造丝绸", "collect_silk")) # Silk
        library = Location("Library", pic = "Library.jpg", menu = ("去饰品店", "visit_katryn"), menu_costs_AP=False) # Katryn, trinkets
        ...
        pilgrim_road = Location("Pilgrim road", pic = "Pilgrim road.jpg", menu = ("去裁缝店", "visit_twins"), menu_costs_AP=False) # Twins, dresses
        banking_quarter = Location("Banking quarter", pic = "Banking quarter.jpg", menu = ("去银行", "visit_bank"), action=True, menu_costs_AP=False)
