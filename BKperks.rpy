...
#                     "Extras" : Perk(name="Extras", type="level", perk_level=1, archetype="The Escort", effects=[Effect("special", "LOCS bonus", 1, chance=0.25)], pic = "escort1_1.jpg"), # Shelving stat bonuses for now
        ...
        naked_perk = Perk(name="Naturist", type="sex", effects = [Effect("special", "naked", 1)])
        pony_perk = Perk(name="Ponygirl", type="sex", effects = [Effect("special", "ponygirl", 1.0, 0.5)])
        bis_perk = Perk(name="Bisexual", type="sex", effects = [Effect("special", "bisexual", 1.0, bis_chance)])
        group_perk = Perk(name="Group", type="sex", effects = [Effect("special", "group", 1.0, group_chance)])
        orgy_perk = Perk(name="Orgy", type="sex", effects = [Effect("special", "orgy", 1.0, 0.5)])
