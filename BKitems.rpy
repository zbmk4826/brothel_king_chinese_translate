...
label init_items():
    python:
        ...
        all_items = [
                    ...
                    Item(name = '绳索', target = 'girl', type = IT_Toy, pic = 'Ropes.webp', rank = 1, rarity = 2, charges = 8, price = 125, effects = (Effect('gain', 'fetish', 1, 0.5), ), description = "休息时有机会改善性虐（有限的使用）。"),
                    Item(name = '手铐', target = 'girl', type = IT_Toy, pic = 'Cuffs.webp', rank = 2, rarity = 3, charges = 8, price = 500, effects = (Effect('gain', 'fetish', 2, 0.5), ), description = "休息时有机会改善性虐（有限的使用）。"),
                    Item(name = '口球', target = 'girl', type = IT_Toy, pic = 'Gag.webp', rank = 3, rarity = 4, charges = 8, price = 2500, effects = (Effect('gain', 'fetish', 3, 0.5), ), description = "休息时有机会改善性虐（有限的使用）。"),
                    Item(name = '眼罩', target = 'girl', type = IT_Toy, pic = 'Blindfold.webp', rank = 4, rarity = 5, charges = 8, price = 10000, effects = (Effect('gain', 'fetish', 5, 0.5), ), description = "休息时有机会改善性虐（有限的使用）。"),
...
#                       Item(name = "Steel Makibishi", target = 'MC', type = IT_Story, pic = 'steel makibishi.webp', template = False, rank = 3, rarity = "S", price = 1500, description = "Slows down Kunoichi movements during ninja hunt (large effect).", hidden_effect = True),
        ...
        template_items =   [
                            ...
                            Item(name = '金币袋子', target = 'girl', type = IT_Misc, pic = 'Gold bag.webp', template = True, rank = 1, max_rank = 5, rarity = 2, charges = 1, price = 600, effects = (Effect('special', 'level', 10), ), description =  "瞬间提升等级。明智地使用它……", adjectives = "ring"),
