...
#### DIFFICULTY ####
    ...
    diff_name = {"very easy" : "小白脸", "easy" : "皮条客", "normal" : "妓女领主", "hard" : "青楼王子", "insane" : "青楼之王{#1}"}

    diff_description = {"very easy" : "完全没有挑战。你要么是来看故事的，要么是来看漂亮图片的。{i}所有成就被锁定。{/i}", "easy" : "新手玩家会遇到一些简单的挑战。", "normal" : "最普通的游戏体验。", "hard" : "想要更多的挑战?困难难度已经帮你搞定了。", "insane" : "终极挑战。"}
...
#### RANDOM TIPS ####
    ...
    random_tips = [
                    ...
                    "迷人的女孩当服务员会更好。",
                    "服务员需要{b}魅力{/b}和{b}体质{/b}。如果是具有较高的{b}美貌{/b}，并且有一个不俗的{b}身材{/b}也不错。",
                    ...
                    "当然，执行性服务需要良好的{b}性服务{/b}技能以及{b}敏感度{/b}。{b}魅力{/b}和{b}性虐{/b}技能也有帮助。",
                    "美貌和性欲对于正常的性行为很重要。",
                    ...
                    "房中术(性爱技能)不能通过升级来提高。唯一的途径就是用实战经验来提升它们。",
                    "课程有助于更快地提高女孩的低级技能。",
    ...
    MC_playerclass_description = {
                                  "战士" : "你是个战士。你可能还年轻，但你经历过的血战不止这些。你在战斗和保护青楼中更有优势。",
...
init -4 python:
    ...
    farm_holding_dict = {"libido" : "照看奴仆{size=-6}(+性欲){/size}",
                            ...
                            "constitution" : "外出工作{size=-6}(+体质){/size}",
                            "rest": "休息",
                            }
...
#                        "group result bad" : "{color=[c_lightred]}%s cried and screamed as the %ss took turns violating her body.{/color} Gizel kept tauting her during the whole ordeal as she sobbed silently.",
                        ...
                        "holding sensitivity bad": " 吉泽尔把%s弄得筋疲力尽，气喘吁吁地倒在地上。{color=[c_lightred]}她的体质受到了影响。{/color}",
    ...
    gstats_dict = {
                    "Beauty" : "{b}美貌：{/b}她看上去真漂亮。影响按摩师的工作和性交效果。{p}目前作为按摩师的可服务人数: {b}%s{/b}",
                    "Body" : "{b}身材：{/b}她的身材多么匀称，多么结实。影响工作效果，如舞蹈和肛交行为。{p}目前作为舞者的可服务人数: {b}%s{/b}",
                    "Charm" : "{b}魅力：{/b}她有多少个性和风度。影响服务员和性服侍的工作效果。{p}目前作为服务员的可服务人数: {b}%s{/b}",
                    "Refinement" : "{b}优雅：{/b}她是多么的聪明博学，举止文雅。影响艺伎和性虐性行为效果。{p}目前作为艺妓的可服务人数: {b}%s{/b}",
                    "Libido" : "{b}性欲：{/b}她是多么渴望性啊。影响性交效果，并增加她能与之发生性关系的顾客数量。{p}目前作为妓女的可服务人数: {b}%s{/b}",
                    "Sensitivity" : "{b}敏感：{/b}她对自己的身体和伴侣是多么的敏感。影响性服侍效果，提高顾客满意度。",
                    "Constitution" : "{b}体质：{/b}她有多大的精力。影响肛交效果和提高她的最大精力。",
                    "Obedience" : "{b}服从：{/b}她多么能接受命令和奴役. 影响性虐性行为效果，降低她拒绝工作的机会。",
                    "Service" : "{b}服侍：{/b}她做手交、口交和其他性服侍行为有多好。",
                    "Sex" : "{b}性交：{/b}她有多擅长性交行为。",
                    "Anal" : "{b}肛交：{/b}她有多擅长肛交行为。",
                    "Fetish" : "{b}性虐：{/b}她对BDSM(绳缚与调教\支配与臣服\施虐与受虐)和其他不寻常的性行为有多在行。"
                    }
...
#                 "extremely reluctant" : "{color=#FF2626}%s{/color}",
    ...
    pejorative_translate_adjective = {
                                    "Slutty" : "淫荡的",
                                    "Careless" : "马虎的",
                                    "Useless" : "差劲的",
                                    "Terrible" : "糟糕的",
...
init python:
    gpersonalities = {
                        "pervert" : Personality(name="pervert",label="变态", attributes=("very extravert", "very lewd"), description="野性和开放的女孩。对各种色色的事情都很好奇，越变态越好。不关心浪漫的事。"),
                        "rebel" : Personality(name="rebel",label="逆反", attributes=("very extravert", "very dom"), often_stories = ["slave_story5"], description="总是与他人争吵和矛盾，有强烈的独立性。必须按照她自己的意愿做事情。"),
                        "cold" : Personality(name="cold",label="冷漠", attributes=("very materialist", "very introvert"), description="冷漠和疏离，她不轻易表露自己的感情。她似乎对周围发生的事情很不关心，对别人的命运也不感兴趣。"),
                        "nerd" : Personality(name="nerd",label="书呆子", attributes=("very introvert", "very idealist"), often_stories = ["slave_story8"], description="沉默寡言，喜欢读书。并不轻浮。好奇心。不喜欢体力劳动。"),
                        "masochist" : Personality(name="masochist",label="受虐狂", attributes=("very introvert", "very sub"), description="越卑微越好。她喜欢呆在底层，并暗自享受被虐待的感觉。礼物和关爱会让她恼火，她觉得自己不配拥有这些东西。"),
                        "bimbo" : Personality(name="bimbo",label="喜好虚荣但头脑简单", attributes=("very materialist", "very lewd"), description="虚荣心强，渴望得到关注，关心地位和财富。喜欢礼物和赞美。她愿意出卖身体来获得这些东西。"),
                        "meek" : Personality(name="meek",label="温顺", attributes=("very modest", "very sub"), often_stories = ["slave_story4"], rarely_stories = ["slave_story5","slave_story8"], description="害羞，容易动摇，会哭泣而不是反抗。不喜欢发生冲突。"),
#                         "heartless" : Personality(name="heartless", attributes=("very materialist", "very dom"), description="Cold, calculating, domineering and selfish. Will always try to benefit at the expense of others."),
                        "sweet" : Personality(name="sweet",label="可爱", attributes=("very idealist", "very extravert"), description="可爱和阳光的个性。始终积极向上的。颇为浪漫。不喜欢消极情绪。"),

                        "superficial" : Personality(name="superficial",label="肤浅", attributes=("very extravert", "very materialist"), description="永远是社会名流，在意自己是否被人注意到，最好是穿着最出色的衣服和昂贵的珠宝。有人说她渴望得到关注，但她知道他们只是嫉妒她的新鞋……"),
                        "holy" : Personality(name="holy",label="圣洁", attributes=("very extravert", "very modest"), never_stories = ["slave_story7","slave_story8"], description="她是宗教和道德的倡导者，每晚都为自己的灵魂得救而祈祷，并试图让别人皈依她的信仰。到目前为止没有什么成效，但她不会放弃。"),
                        "helper" : Personality(name="helper",label="乐于助人", attributes=("very extravert", "very sub"), description="她总是为朋友着想，并且经常把别人事情放在第一位。有时会有点多管闲事。"),
                        "creep" : Personality(name="creep",label="闷骚", attributes=("very introvert", "very lewd"), description="她在人前显得害羞而笨拙，对各种色色的话题都很着迷，她总在私下时间里进行研究。因跟踪而被经常投诉。"),
                        "repressed" : Personality(name="repressed",label="克制", attributes=("very introvert", "very modest"), description="在一个非常严格的环境中长大，她生活在对自己冲动的恐惧中，并竭力压制它们。"),
                        "schemer" : Personality(name="schemer",label="阴谋家", attributes=("very introvert", "very dom"), description="她最喜欢的是策划和制定宏伟的计划，总有一天对所有的生物进行统治……同时，如果她计划中必须吸吮一个肉棒……那就这样吧。"),
                        "prude" : Personality(name="prude",label="故作正经", attributes=("very materialist", "very modest"), rarely_stories = ["slave_story7","slave_story8"], description="在任何时候都要做一个敬畏阿里纳斯的好女孩。不赞成轻浮和不道德的行为。有人认为她暗地里有肮脏的想法，但如果是这样，她隐藏得很好。"),
                        "princess" : Personality(name="princess",label="公主病", attributes=("very dom", "very materialist"), often_stories = ["slave_story6"], rarely_stories = ["slave_story1","slave_story2","slave_story3","slave_story5","slave_story7","slave_story8"], never_stories = ["slave_story4"], description="她外表看着像的公主（或者说她是？），她认为每个人都应该为她服务，满足她的每一个要求。她可以很残忍，但大多数情况下她是天真无邪的。"),
                        "pet" : Personality(name="pet",label="宠物", attributes=("very materialist", "very sub"), rarely_stories = ["slave_story5","slave_story8"], description="教师的宠物。总是准备好取悦她的主人，喜欢在他脚下舒适地生活。有些人看不起她的不独立，在背后骂她不讨好。"),
                        "easy" : Personality(name="easy",label="随和", attributes=("very lewd", "very idealist"), description="这不是她的错，她总是吸引男人，而且从来不忍心拒绝他们。虽然很多人说她很容易相处，但她唯一的目的是传播快乐。但愿不是传播性病。"),
                        "class president" : Personality(name="class president",label="班长", attributes=("very modest", "very idealist"), often_stories = ["slave_story8"], description="必须始终处于领先地位，努力成为模范，鄙视各种不当行为。她对他人的高期望值反映了她对自己的严苛要求。"),
                        "tsundere" : Personality(name="tsundere",label="傲娇", attributes=("very idealist", "very dom"), description="易怒、难伺候，她有一个秘密的软肋。为了帮助别人，时常让自己处于危险之中，然后因为他们需要帮助而踢他们的屁股。"),
                        "loyal" : Personality(name="loyal",label="忠心耿耿", attributes=("very idealist", "very sub"), often_stories = ["slave_story2"], description="总是服从命令，出于责任感而不是恐惧。认为每个人都必须清楚自己的位置，无论从事什么工作都要做到最好。甚至是妓女。"),
                        "yandere" : Personality(name="yandere",label="病娇", attributes=("very lewd", "very dom"), rarely_stories = ["slave_story3","slave_story7"], description="热情和神经质的程度非常高。充满爱心和奉献精神，但也是个疯子。为了得到她的男人并扼杀竞争对手，她准备做任何事情，包括……真正扼杀他们。"),
                        "masochist2" : Personality(name="masochist",label="受虐狂2", attributes=("very lewd", "very sub"), description="地位越低越好。她喜欢在底层，享受各种强加在她身上的肮脏事情。礼物和爱的姿态让她恼火，她觉得自己不配拥有这些东西。"),
                        "stubborn" : Personality(name="stubborn",label="固执", attributes=("very modest", "very dom"), description="不喜欢不认同她的原则和道德价值观的人，也不喜欢闹矛盾。她在派对上很有趣，如果你喜欢以酒馆斗殴结束的派对的话。"),
                     }
...
#                            "extremely reluctant" : 100, # (obsolete)
    ...
    interact_dict = {
                    ...
                    "misc" : ["{font=[gui.yishu]}{size=18}服装{/font}", "{font=[gui.yishu]}{size=18}你的卧室{/font}", "{font=[gui.yishu]}{size=18}DEBUG{/font}"],
                    ...
                    "{font=[gui.yishu]}{size=18}你的卧室{/font}" : [
    ...
    free_interact_dict = {
                            ...
                            "{font=[gui.yishu]}{size=18}关于性的话题{/font}" : [
                                                ...
                                                GirlInteractionTopic("flirt", "chat about sex", "服侍　　", "free_flirt_sex_act", act="service", love_test=55),
                                                ...
                                                GirlInteractionTopic("flirt", "chat about sex", "性虐　", "free_flirt_sex_act", act="fetish", love_test=55),
...
init -4 python:
    ...
    generic_gossip = [
                        ...
                        "她精致的容貌和举止使公主成为所有的瓒城贵族和平民一样的心上人。",
                        ...
                        "所有的游客都同意一件事:瓒最好的地方是它的性奴隶……任何一种性幻想都可以在这里实现。许多奴隶以满足主人的欲望为傲。",
                        ...
                        "经过一天的辛苦工作，有什么比去一个美女夜总会，然后让她们中的一个脱光衣服，倒在你身上更性感呢？我理解你们的想法。",
    ...
    district_gossip = {"The Slums" : [
                       ...
                       "The Magic Gardens" : [],
                       "The Cathedra" : [
                                        "大教堂是瓒的骄傲，是克塞洛斯王冠上的宝石。所有人都在阿里奥斯的光辉中欢欣鼓舞！",
...
#                        "roll_critical success" : "\n{color=[c_green]}%s did everything she could to please the customers.{/color}",
                        ...
                        "dancer_average" : "\n%s在顾客面前挑逗地跳舞。",
                        "dancer_good" : "\n{color=[c_lightgreen]}当%s在舞台上翩翩起舞时，夜总会开始活跃起来。",
...
init -2 python:
    ...
    contract_description = {"cruise" : ":ORG:正在:dis:组织一次夜间巡游以感谢其成员今年的辛勤工作。:AVEN:将在黄昏时分出发前往海湾观光，然后停泊在:LOC:旁边，享受一个娱乐之夜。",
                            ...
                            "orgy" : ":ORG:很高兴地宣布，在:LOC:中，会有一个漫长的享乐主义和色情惊喜的夜晚。聚集在:aven:，客人们将与志同道合的人和精心挑选的精英性奴一起享受禁忌的快乐。"}

init python:

    contract_templates = [Contract(type="cruise", district="The Docks", archetypes = ["The Player", "The Fox"],
                                   names=["海上之夜", "游览瓒城的港湾", "退役的水手", "梦幻般的巡游"],
                                   organizers=["水手协会", "瓒城的海军", "弗利布斯特社交夜总会", "北方商船"],
                          ...
                          Contract(type="festival", district="The Slums", archetypes = ["The Player", "The Fox"],
                                   ...
                                   organizers=["矮胖子南瓜", "农民协会", "瓒城的乡村夜总会", "园艺兄弟会", "房东合作社", "来自山谷的肮脏嬉皮士", "牧羊人联合会"],
    ...
    contract_task_types_description = {"greet" : "迎接贵宾", "serve" : "服务宾客", "mingle" : "交际", "event" : "参加活动", "private show" : "举办私人演出", "fun" : "寻欢作乐"}
