...
label free_girl_talk(girl):
    ...
    if not girl.MC_interact:
        ...
        $ text1 = rand_choice(("当你走在%s时，", "在前往%s的途中，", "心不在焉地在%s街上闲逛，")) % location_name_dict[selected_location.name]
...
label free_flirt_sex_act(girl):
    ...
    if act == "naked":
        ...
        $ girl.personality_unlock["MI"] += 10 + MC.get_charisma() + dice(6) # Temp, see how it behaves
        $ MC.rand_say(("曾经有和女孩做过吗？", "你喜欢和其他女孩在一起吗？", "听说过双飞吗？你试过吗？", "tr: 在博尔格，渔妇们喜欢互相磨光彼此的珍珠。你呢？",
                        "你是双飞吗？", "你喜欢女孩子吗？", "ev: 只有婊子才知道。你有没有试过和女孩上床？", "ne: 男人还是女人，这对你来说有什么关系吗？", "gd: 你很迷人也很有爱心，我相信女人也喜欢你。不是吗？", "sh: 崇拜女神总是比崇拜神灵更令人满意，你觉得呢？",
                        ))
