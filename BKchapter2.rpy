...
label c2_intro():
    ...
    $ district_chinese_name = location_name_dict[district.name]
...
label c2_suzume_invitation2():
    ...
    $ game.set_task("去{b}海滨{/b}的高档女主人夜总会。")
...
label c2_palace_visit1(): # Happens after all Kunoichi have been met once
    ...
    call screen letter(header = "会议邀请",
                       message = "亲爱的" + MC.name + ",\n\n我希望你收到这封信时一切安好,而且你在我们共同感兴趣的问题上取得了一些进展。 请在您方便的时候尽早到宫里来见我。",
                       signature = "库洛公主")
