...
#                 tooltip "The current date."
        ...
        textbutton "?" tooltip "了解更多关于当前界面的信息。":
            ...
            vbox:
                ...
                if context != "free" or girl.MC_relationship_level >= 1:
                    ...
                    button:
                        background None
                        action NullAction()
                        tooltip "她还有{b}" + str_int(girl.energy) + "{/b}点精力。\n她的最大精力为{b}" + str_int(girl_max) + "{/b} (增加体质可以提高精力上限)"
                        keyboard_focus False
                        yfill False
                        ysize yres(30)
...
#        spacing 60
        ...
        vbox:
            ...
            text "要求\n没有牌照" xalign 0.5 yalign 0.0 size res_font(16) text_align 0.5 color c_darkgrey
        ...
        vbox:
            ...
            hbox:
                ...
                text "要求\n皮条客牌照" xalign 0.5 yalign 0.0 size res_font(16) text_align 0.5 color c_darkgrey
        ...
        vbox:
            ...
            hbox:
                ...
                text "要求\n妓女贩牌照" xalign 0.5 yalign 0.0 xsize res_font(160) size res_font(16) text_align 0.5 color c_darkgrey
        ...
        vbox:
            ...
            hbox:
                ...
                text "要求\n青楼主牌照" xalign 0.5 yalign 0.0 xsize xres(150) size res_font(16) text_align 0.5 color c_darkgrey
...
screen visit_district():
    ...
    textbutton "<" xalign 0.05 ysize yres(120) yalign 0.4 action (SetVariable('selected_district', get_previous(available_districts, selected_district, loop=True)), Jump("visit_district")) tooltip "去上一个的区域（您可以使用方向键）。"

    textbutton ">" xalign 0.95 ysize yres(120) yalign 0.4 action (SetVariable('selected_district', get_next(available_districts, selected_district, loop=True)), Jump("visit_district")) tooltip "去下一个区域（你可以使用方向键）。"
...
screen visit_location():
    ...
    textbutton "<" xalign 0.05 ysize yres(120) yalign 0.4 action (SetVariable('selected_location', _previous), Jump("visit_location")) tooltip "去该地区上一个地点（您可以点击箭头）。"

    textbutton ">" xalign 0.95 ysize yres(120) yalign 0.4 action (SetVariable('selected_location', _next), Jump("visit_location")) tooltip "去该地区下一个地点（您可以点击箭头）。"
        ...
        hbox:
            ...
            if not brothel_firstvisit:
                ...
                frame:
                    ...
                    text "{b}你的卧室{/b}" size res_font(18) xalign 0.0 drop_shadow (2, 2)
...
screen furniture():
    ...
    frame ypos 0.05 background None xmargin 20 ymargin 20:
        ...
        text "木匠货车" bold True xalign 0 yalign 0
                            ...
                            hbox spacing 6:
                                button background None xalign 0.0 yalign 0.5:
                                    ...
                                    if brothel.get_effect("allow", pop.name):
                                        ...
                                        tooltip "{size=-1}必须在木匠货车上建造新的装饰物来吸引这些顾客。"
                                    ...
                                    hbox spacing 6:
                                        textbutton girl_related_dict[pref.capitalize()] xsize xres(120) ypadding 5 text_size res_font(18) yalign 0.5:
                                            ...
                                            if brothel.get_effect("allow", pref + " preference"):
                                                ...
                                                background "#CCB8A0"
                                                text_color c_white
                                                tooltip "你必须在木匠的货车上做相应的装饰或家具才能修改顾客选择“" + girl_related_dict[pref] + "”服务的优先权。"
                    ...
                    vbox xsize 130 xfill True:
                        ...
                        button:
                            ...
                            if inst.can_upgrade():
                                ...
                                action NullAction()
                                if inst.rank < 5:
                                    hovered tt.Action("你无法升级" + farm_related_dict[inst.name] + "直到你获得更高的青楼牌照。")
                                else:
...
screen h_content():
    ...
    viewport xsize 0.8:
        ...
        frame:
            ...
            text "\n群体和双飞图片的行为选项" color c_brown italic True size res_font(16)
            ...
            textbutton {True: "双飞：将双飞图片与普通图片混合", False: "双飞：只使用双飞图片"}[persistent.mix_bis_pictures] text_size res_font(18) xalign 0.0 xsize 0.8 xfill True action ToggleField(persistent, "mix_bis_pictures")
    ...
    vbox xalign 1.0 xfill False:
        ...
        viewport xalign 1.0 xsize xres(250):
            ...
            if mode == "soft":
                ...
                textbutton "服侍" text_size res_font(18) action SetScreenVariable("pic", girl.get_pic(perform_job_dict["service_tags"], "naked", "rest", "profile", not_tags=["monster", "beast", "machine", "group", "bisexual"]))
                ...
                textbutton "性虐" text_size res_font(18) action SetScreenVariable("pic", girl.get_pic(perform_job_dict["fetish_tags"], not_tags=["monster", "beast", "group", "bisexual"]))
                textbutton "双飞 服侍" text_size res_font(18) action SetScreenVariable("pic", girl.get_pic(perform_job_dict["bisexual_tags"], perform_job_dict["service_tags"], and_tags= ["service"], not_tags=["monster", "beast", "machine", "group"], and_priority=False))
                ...
                textbutton "双飞 性虐" text_size res_font(18) action SetScreenVariable("pic", girl.get_pic(perform_job_dict["bisexual_tags"], perform_job_dict["fetish_tags"], and_tags= ["fetish"], not_tags=["monster", "beast", "group"], and_priority=False))
                textbutton "群交 服侍" text_size res_font(18) action SetScreenVariable("pic", girl.get_pic(perform_job_dict["group_tags"], perform_job_dict["service_tags"], and_tags= ["service"], not_tags=["monster", "beast", "machine"], and_priority=False))
                ...
                textbutton "群交 性虐" text_size res_font(18) action SetScreenVariable("pic", girl.get_pic(perform_job_dict["group_tags"], perform_job_dict["fetish_tags"], and_tags= ["fetish"], not_tags=["monster", "beast"], and_priority=False))
                ...
                textbutton "种马 服侍" text_size res_font(18) action SetScreenVariable("pic", girl.get_pic("service", and_tags = ["big"], not_tags=["monster", "beast", "machine"]))
                ...
                textbutton "种马 性虐" text_size res_font(18) action SetScreenVariable("pic", girl.get_pic("fetish", and_tags = ["big"], not_tags=["monster", "beast"]))
                ...
                textbutton "野兽 服侍" text_size res_font(18) action SetScreenVariable("pic", girl.get_pic("beast", and_tags = ["service"]))
                ...
                textbutton "野兽 性虐" text_size res_font(18) action SetScreenVariable("pic", girl.get_pic("beast", and_tags = ["fetish"]))
                ...
                textbutton "怪物 服侍" text_size res_font(18) action SetScreenVariable("pic", girl.get_pic("monster", and_tags = ["service"]))
                ...
                textbutton "怪物 性虐" text_size res_font(18) action SetScreenVariable("pic", girl.get_pic("monster", and_tags = ["fetish"]))
                ...
                textbutton "机器 服侍" text_size res_font(18) action SetScreenVariable("pic", girl.get_pic(["machine", "toy"], and_tags = ["service"]))
                ...
                textbutton "机器 性虐" text_size res_font(18) action SetScreenVariable("pic", girl.get_pic(["machine", "toy"], and_tags = ["fetish"]))
